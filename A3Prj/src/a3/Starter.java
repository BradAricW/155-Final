...
//------a2 setup-----------------------------------------//
		...
		ResetAction rAction = new ResetAction(cam, this);
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		v_matrix.rotate(cam.getU(),  cam.getV(), cam.getN());
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		joglX = loadTexture("src/a3/x.jpg");
		xAxisTexture = joglX.getTextureObject();
		
		joglY = loadTexture("src/a3/y.jpg");
		yAxisTexture = joglY.getTextureObject();
		
		joglZ = loadTexture("src/a3/z.jpg");
...
//-----------------
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		vBlinn1ShaderSource = util.readShaderSource("src/a3/blinnVert1.shader");
		vBlinn2ShaderSource = util.readShaderSource("src/a3/blinnVert2.shader");
		fBlinn2ShaderSource = util.readShaderSource("src/a3/blinnFrag2.shader");
